...
void loop() {
   ...
   */  
  if ((error_1 == 1)&&(error_2 ==1)) //skip loop if no controller found
    return; 
  

  else { //DualShock Controller
    ps2x_1.read_gamepad(false, vibrate_1); //read controller and set large motor to spin at 'vibrate' speed
    ps2x_2.read_gamepad(false, vibrate_2); //read controller and set large motor to spin at 'vibrate' speed
